...
def clean_text(raw, max_len: int) -> str:
    # \r y \n tienen que entrar en el conjunto permitido: isprintable() los
    # da por no imprimibles y los BORRABA aqui, antes de que la linea de
    # abajo pudiera cambiarlos por un espacio. Resultado: "hola\nmundo"
    # llegaba como "holamundo" en vez de "hola mundo".
